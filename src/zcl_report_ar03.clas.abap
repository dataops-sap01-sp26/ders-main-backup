CLASS ZCL_REPORT_AR03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS ZCL_REPORT_AR03 IMPLEMENTATION.
  ...
  METHOD ZIF_REPORT~EXECUTE.
    ...
    RS_RESULT-FILE_NAME_PREFIX = |AR_Aging_Report_{ MS_PARAMS-REPORT_ID }|.
  ENDMETHOD.
  ...
  METHOD QUERY_DATA.
    ...
    " 3. Select Data from Aging View
    SELECT FROM ZI_RPT_AR03
      FIELDS CompanyCode,
             Customer,
             CustomerName,
             TotalAmount,
    ...
    CREATE DATA ER_DATA LIKE LT_AR03.
    FIELD-SYMBOLS <LT_OUT> TYPE STANDARD TABLE.
    ASSIGN ER_DATA->* TO <LT_OUT>.
    <LT_OUT> = LT_AR03.

*    DATA(LO_STRUCT) = CAST CL_ABAP_STRUCTDESCR(
*      CL_ABAP_TYPEDESCR=>DESCRIBE_BY_DATA( VALUE #( LT_ar03[ 1 ] OPTIONAL ) ) ).
