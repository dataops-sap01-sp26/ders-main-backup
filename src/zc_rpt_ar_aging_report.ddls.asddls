...
@EndUserText.label: 'Projection View for AR Aging Report'
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
@Search.searchable: true

define root view entity ZC_RPT_AR_AGING_REPORT
  as select from ZI_RPT_AR_AGING_REPORT
  
  association [0..*] to ZC_RPT_AR_AGING_REPORT_I as _Items
