CLASS ZCL_FILE_SIZE_CALC_JOB_HISTORY DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_FILE_SIZE_CALC_JOB_HISTORY IMPLEMENTATION.

  METHOD IF_SADL_EXIT_CALC_ELEMENT_READ~CALCULATE.
    " 1. Cast the input data from CDS to an internal table with the CDS View structure
    DATA LT_ORIGINAL_DATA TYPE STANDARD TABLE OF ZC_DRS_JOB_HISTORY WITH DEFAULT KEY.
