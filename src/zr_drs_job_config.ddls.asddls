...
define root view entity ZR_DRS_JOB_CONFIG
  as select from zdrs_job_config as JobConfig
  composition [0..*] of ZI_DRS_FILE   as _File
  association [0..1] to ZR_DRS_SUBSCR as _Subscription on $projection.SubscrId = _Subscription.SubscrId
  and $projection.SubscrUuid = _Subscription.SubscrUuid
{
