CLASS ZCL_REPORT_AP03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS ZCL_REPORT_AP03 IMPLEMENTATION.
  ...
  METHOD ZIF_REPORT~EXECUTE.
    ...
    RS_RESULT-FILE_NAME_PREFIX = |AP_Aging_Report_{ MS_PARAMS-REPORT_ID }|.
  ENDMETHOD.
  ...
  METHOD QUERY_DATA.
    ...
    " 2. Prepare Vendor Range (Use md_supplier for Vendors)
    DATA LT_VENDOR_RANGE TYPE RANGE OF MD_SUPPLIER.
    ...
    SELECT FROM ZI_RPT_AP03
      ...
      INTO TABLE @DATA(LT_AP03)
      UP TO @LV_MAX ROWS.

    CREATE DATA ER_DATA LIKE LT_AP03.
